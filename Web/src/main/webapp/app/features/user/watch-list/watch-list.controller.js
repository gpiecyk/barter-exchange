export default class WatchListController {
    ...
    findOffersObservedByUser() {
        this.offerService.findOffersObservedByUser(this.userService.user.id).then((response) => this.onSuccessGetOfferHandler(response),
